...
@section('content')
@include('includes.header', ['pageTitle'=>'Nominal Transfer', 'back'=>'/transfer'])
<div>
    <div class='bg-grad-pink h-screen font-bolxtd w-full te-3xl px-6 flex flex-col items-center justify-center text-sm'>
        ...
        <form action="{{ url('/transfer/konfirmasi') }}" method="post" class="flex flex-col w-72">
            ...
            <div class="flex gap-2">
                <a href="{{ url('/transfer') }}" class="bg-white w-1/2 font-semibold text-center text-c-pink border border-c-pink px-6 py-2 rounded-xl mt-6">
                    BATAL
                </a>
        ...
        <div class="grid grid-cols-3 gap-10 mt-6 text-lg">
