...
<div>
    <div class='bg-white h-screen p-6 font-bolxtd w-full te-3xl flex flex-col items-center text-sm gap-3'>
        ...
        <form class='flex flex-row gap-3 items-center justify-center w-full p-2'>
            <input type="text" id="inputQuery" placeholder="Masukkan kata kunci pencarian" class="w-full p-3 rounded-xl placeholder:text-gray-400 text-c-earlier-black border border-c-blue-white">

            <button class="bg-blue-300 rounded-xl h-full flex items-center justify-center p-2">
            ...
            <div class='border-2 border-blue-white w-full h-auto rounded-xl py-2'>
                <div class='grid grid-cols-[55px_155px_105px] flex items-center justify-center'>
                    ...
                    <div>
                            ...
                            <p class='text-sm text-c-blue-white'>09 Agustus 2023</p>
                    </div>                    
